  ...
  return (
    <SafeAreaView className="flex-1 px-4 bg-white items-center justify-between">
      ...
      <View className="flex-1 items-center justify-center px-4">
        ...
        <Text className="text-center mt-4 text-slate-600">
          Digite o endereço de email associado a sua conta de usuário que nós
          vamos enviar um link para que você resete a sua senha.
        </Text>
      </View>
